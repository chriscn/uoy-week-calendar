...
import {academicYears, CalendarType, getAcademicYear, getCurrentAcademicYear, getNextPeriod} from "./calendar";
...
function generateCalendarFiles() {
...
// Generate Dates JSON File
function generateDateFile() {
    console.log('Generating dates json file...')
}
